...
// Lumak: interfaces added
extern DECLSPEC const char * SDLCALL SDL_AndroidGetExternalStoragePublicPath();
typedef void (*UserActivityCallback)(int ival, int istat, const char *str, void *param);
extern DECLSPEC void SDLCALL SDL_RegisterUserActivityCallback(UserActivityCallback callback, void *param);
