...
//=============================================================================
// Lumak: SDL_AndroidGetExternalStoragePublicPath
//=============================================================================
...
//=============================================================================
// sdl and jni user activity callback fn
//=============================================================================
static UserActivityCallback userActivityCallback = NULL;
static void *activityCallbackParam = NULL;

void SDL_RegisterUserActivityCallback(UserActivityCallback callback, void *param)
{
    userActivityCallback = callback;
    activityCallbackParam = param;
}

JNIEXPORT void JNICALL Java_org_libsdl_app_SDLActivity_nativeUserActivityCallback(JNIEnv* env, jclass cls, jint ival, jint istat, jstring jstrParam)
{
    const char *str = (*env)->GetStringUTFChars(env, jstrParam, 0);

    if (userActivityCallback)
    {
        (*userActivityCallback)(ival, istat, str, activityCallbackParam);
    }
