...
public class SDLActivity extends Activity {
    ...
    // Lumak: change - load your .so
    static {
        System.loadLibrary("75_JoystickAndroid"); // actual filename has "lib" prefix and ".so" suffix, e.g. "lib75_Joystick.so" under jniLibs
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Lumak: added - intialize app after mLayout is created
        InitializeApp();
    ...
    // the nativeUserActivityCallback() fn, defined in ThirdParty/SDL/src/core/android/SDL_android.c/.h
